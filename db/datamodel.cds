...
context transaction {   //for transaction data
   ...
   entity purchaseorder : common.Amount, cuid {    //po table
        // key NODE_KEY : Guid;  node key will autogenerated by using CUID               	
        PO_ID  : String(32);
        ...
        //association to many poitems on Items.PARENT_KEY = $self
   }
